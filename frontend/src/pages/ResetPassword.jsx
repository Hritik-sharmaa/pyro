...
const ResetPassword = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-950 text-white bg font-mono bg">
      <form
        ...
        <button
          type="submit"
          className="w-full bg-black text-white py-2 px-4 rounded-full hover:bg-zinc-900 transition duration-200">
          Reset Password
        </button>
      </form>
    </div>
