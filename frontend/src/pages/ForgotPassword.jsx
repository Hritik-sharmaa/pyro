...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg text-white">
      <form
        ...
        <button
          type="submit"
          className="w-full bg-black text-white py-2 px-4 rounded-lg hover:bg-zinc-950 transition duration-200"
          disabled={isLoading}>
